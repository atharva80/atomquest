...
- main:
  ...
  - text: smart_toy
  - heading "AI Performance Insights" [level=4]
  - text: Live
  - paragraph: Dwight has strategically prioritized "Increase Efficiency" with a significant 78% weightage, though his current 0.0% weighted score indicates a critical need for immediate achievement updates. He should focus on recording his latest metrics and refining the "asdad" goal title to ensure his progress is accurately captured and aligned with professional standards.
  - button "sync Regenerate"
  - text: scale
  - heading "Total Weightage Distribution" [level=3]
  - text: 100 / 100%
  - progressbar
  - paragraph: Your goals account for 100% of your available quarter capacity. No further allocation required.
  - text: Thrust Area
  - heading "asdad" [level=4]:
    - link "asdad":
      - /url: /employee/goals/f372e0a8-eda9-4253-9310-778f1238a931
  - text: SUBMITTED
  - separator
  - text: Target Value 11% Weightage 22% Thrust Area
  - heading "Increase Efficiency" [level=4]:
    - link "Increase Efficiency":
      - /url: /employee/goals/f4c2a4ad-0afd-46c1-89ff-ec9901542b86
  - text: SUBMITTED
  - separator
  - text: Target Value 90 Weightage 78%
- button:
  - img
  - img
