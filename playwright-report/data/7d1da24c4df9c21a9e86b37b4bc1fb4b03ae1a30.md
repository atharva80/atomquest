...
Locator: locator('span:has-text("Simulated")').or(locator('span:has-text("Insights")')).first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('span:has-text("Simulated")').or(locator('span:has-text("Insights")')).first()
...
- main:
  ...
  - text: Live
  - paragraph: Could not load progress summary. Please try again.
